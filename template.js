...
var promptsCallbackWrapper = function(done){
  return function promptsCallback(err, props) {
...
exports.template = function(grunt, init, done) {
  // When I moved the inline callback out of this function scope, the callback
  // lost the reference to `done`. 
  // We'll pass `done` into the wrapper. Now the returned callback has the reference.
  var promptsCallback = promptsCallbackWrapper(done)

  // Start the interactive configuration process.
  init.process({}, prompts, promptsCallback);
};
