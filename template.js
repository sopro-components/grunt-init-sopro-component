  ...
  init.process(
    ...
    ,[
      ...
      init.prompt('title'),
      {
        name: 'description',
        message: 'Description',
        default: 'A component that was autogenerated by grunt',
        warning: ''
      },
      {
        name: 'repository',
      ...
      // Invoke custom prompts:
      {
        ...
        message: 'Will you be compiling jade to html?',
        default: 'no',
        warning: ''
      },
      {
